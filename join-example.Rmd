...
Objective: show that a "join" is like an overlap
...
`complete()` command at the end fills in 0 for those classmates for
whom we share no friends (here, the `factor()` command earlier becomes
relevant).
